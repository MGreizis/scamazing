...
export default class Level extends Scene {
    ...
    render() {
        ...
        this.game.writeTextToCanvas("To enter a door, move your character over it and press 'spacebar'", 30, this.game.canvas.width, this.game.canvas.height - 1, 'right', 'black');
    }
}
